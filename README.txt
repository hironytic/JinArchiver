=============================================================================
このリポジトリは https://osdn.jp/projects/jindolf/scm/hg/JinArchiver/ から
フォークしたものです。
目的はG国で絵文字を含む発言の変換に失敗するのを回避するための修正ですが、
フォーク元の JinArchiver が 1.503.2 版以降でこの問題を解決しているため、
そちらの使用をオススメします。
このリポジトリの今後のメンテナンス予定はありません。
=============================================================================
